...
export class Context {
  ...
  getTechnicalChallenges() {
    ...
    const challengeMap = {
      ...
      'analytics-data-viz': 'real-time streaming, large-scale aggregation, interactive UX',
      'computer-graphics': 'rendering performance, memory bandwidth, shader compilation',
      'webassembly': 'sandboxing, ABI compatibility, performance across browsers',
      ...
      'go': 'concurrency patterns, memory profiling, deployment footprints',
  ...
  getBusinessContext() {
    const contextMap = {
      ...
      'analytics-data-viz': 'data-driven decision-making environments',
      'computer-graphics': 'visual computing and rendering ecosystems',
      'webassembly': 'portable high-performance modules in the web platform',
      ...
      'go': 'cloud-native services and tooling ecosystem',
  ...
  getCaseStudy() {
    const caseStudyMap = {
      ...
      'analytics-data-viz': 'real-time analytics dashboard at scale',
      'computer-graphics': 'GPU-accelerated rendering engine',
      'webassembly': 'WASM-accelerated image processing in-browser',
      ...
      'go': 'high-throughput message processing service',
